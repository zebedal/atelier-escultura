...
const SideNav = ({open, openNav}) => {
    ...
    return(
        ...
        <nav>
            <Link to="/" className={styles['nav-links']}>Home</Link>
            <Link to="/bio" className={styles['nav-links']}>Bio</Link>
            <Link to="/portfolio" className={styles['nav-links']}>Portfolio</Link>
            <Link to="/contact" className={styles['nav-links']}>Contactar</Link>
        </nav>
